        ...
        try:		
                ...
                if archiveIt == False and wayback == False:
                        ...
                        if fa.find("archdesc/phystech") is None:
                                ...
                                phystechP.text = "This collection contains web archives harvested as part of the UWM Web Collection."
                                fa.find("archdesc").insert(1, phystech)
                        else:
                                phystechP=ET.Element("p")
                                phystechP.text ="This collection also contains web archives harvested as part of the UWM Web Collection."
                                fa.find("phystech").append(phystechP)
                        #for debugging:
                        ...
                        for series in fa.find("archdesc/dsc"):
                                if series.tag == "c01":
                                        if series.attrib["id"] == webArchSeries:
                                                ...
                                                series.set("otherlevel","Web Archives")
                                                #find or create <did>
                                                ...
                                                if series.find("acqinfo") is None:
                                                        ...
                                                        acqP1.text = "Web crawling is managed through the Internet Archive's Archive-It service. This series includes links to both the UWM Web collection and the Internet Archive's public collection."
                                                        ...
                                                        #NYCLU <acqinfo> text
                                                        elif archiveItCollection == "4389":
                                                                acqP2.text = "Web Records of the Society of American Archivists are harvested on an annual basis following posting of Annual Reports from component groups following the SAA Annual Meeting in July or August. For more information on records to be crawled, see the SAA Records Retention Policy (2014)."
